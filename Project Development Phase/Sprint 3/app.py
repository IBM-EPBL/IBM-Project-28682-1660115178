...
app.config['uid'] = 'ggt66406'
app.config['pwd'] = '3KfJl6HGDtPdbIWy'
app.config['security'] = 'SSL'
try:
    mysql = DB2(app)

    conn_str=ibm_db.connect("database=bludb;hostname=125f9f61-9715-46f9-9399-c8177b21803b.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;port=31321;protocol=tcpip;\
            uid=ggt66406;pwd=3KfJl6HGDtPdbIWy;security=SSL","","")
...
def register():
    ...
    if request.method == 'POST' :
        ...
        res = ibm_db.exec_immediate(conn_str, param)
        print("---- ")
        ...
        if account:
            ...
            stmt2 = ibm_db.prepare(conn_str, sql2)
...
def today():
    ...
    #   print(texpense)
      ...
      res1 = ibm_db.exec_immediate(conn_str, param1)
